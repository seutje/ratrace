...
export const workerSnapshotIntervalTicks = 2;
...
export const STARTER_POPULATION = 2500;
...
export const COMMERCIAL_STARTING_CASH = INDUSTRIAL_STARTING_CASH;
export const TREASURY_RESERVE_TARGET = 6000;
export const INDUSTRIAL_SUBSIDY_PER_HOUR = 8;
export const COMMERCIAL_SUBSIDY_PER_HOUR = INDUSTRIAL_SUBSIDY_PER_HOUR;
export const HOUSEHOLD_GROWTH_COST = 100;
export const HOUSEHOLD_GROWTH_HAPPINESS_THRESHOLD = 50;
export const HOUSEHOLD_GROWTH_WALLET_THRESHOLD = 100;
export const CITY_DEVELOPMENT_WALLET_RESERVE = 140;
export const CITY_DEVELOPMENT_RESIDENTIAL_COST = 160;
export const CITY_DEVELOPMENT_COMMERCIAL_COST = 240;
export const CITY_DEVELOPMENT_INDUSTRIAL_COST = 280;
export const CITY_DEVELOPMENT_PERMIT_FEE = 40;
export const CITY_DEVELOPMENT_SUPPLIER_PAYOUT = 120;
export const CITY_DEVELOPMENT_COMMERCIAL_STARTUP_CASH = 80;
export const CITY_DEVELOPMENT_INDUSTRIAL_STARTUP_CASH = 120;
export const INHERITANCE_TAX_RATE = 0.15;
